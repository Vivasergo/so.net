                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header"><h4
                                    id="transition-modal-title">{props.error.response.status} error has occurred</h4>
                                    <button type="button" className="btn-close"></button>
                                </div>
                                <div className="modal-body">
                                    <p id="transition-modal-description">{props.error.message}</p>
                                </div>
                                <div className="modal-footer">
                                 <button onClick={handleClose} type="button" className="btn btn-warning">Close</button>
